...
function access(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((user === null || user === void 0 ? void 0 : user.access) === "full") {
            ...
            ctx.reply(`🛑 *Acesso Restrito!*\nPara ter acesso \`FULL\`, efetue o pagamento de *R$${amount},00* via Pix. Assim que o pagamento for aprovado, seu acesso será liberado automaticamente.`, { parse_mode: "Markdown" });
            try {
                ...
                if ((_f = (_e = response === null || response === void 0 ? void 0 : response.point_of_interaction) === null || _e === void 0 ? void 0 : _e.transaction_data) === null || _f === void 0 ? void 0 : _f.qr_code) {
                    ...
                    yield ctx.reply(`🔑😊 Aqui está a chave Pix para pagamento de \*R$${amount}\*. Copie e cole a chave abaixo para efetuar o pagamento. Assim que o pagamento for aprovado, seu acesso será liberado automaticamente.
...
Chave Pix Copia e Cola: \`${pixCopyPasteKey}\``, { parse_mode: "Markdown" });
                ...
                const checkPayment = () => __awaiter(this, void 0, void 0, function* () {
                    for (let i = 0; i < 36; i++) { // 36 tentativas (3 minutos / 5 segundos)
                        try {
                            ...
                            if ((paymentStatus === null || paymentStatus === void 0 ? void 0 : paymentStatus.status) === "approved") {
                                ...
                                yield ctx.reply("✅ *Pagamento aprovado!* Seu acesso foi atualizado para FULL.", { parse_mode: "Markdown", reply_markup: menus_1.backMenu });
                    ...
                    yield ctx.reply("⏳ Tempo expirado! O pagamento não foi concluído dentro do prazo.");
